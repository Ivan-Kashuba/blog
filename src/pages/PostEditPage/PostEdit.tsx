...
type props_T = {
  post: Post;
  updatePost: ({ title, fullText, description }: setPostsPayload_T) => void;
  onPostPhotoChange: (event: React.ChangeEvent<HTMLInputElement>) => void;
};

const PostEdit = ({ post, updatePost, onPostPhotoChange }: props_T) => {
  return (
    <>
      <Formik
        initialValues={{
